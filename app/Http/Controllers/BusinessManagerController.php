...
class BusinessManagerController extends Controller
{
    //
        ...
        public function index(){
            ...
            $activeBusinessManagers = User::where('role', 'businessManager')->where('actif', 1)->get();
    
            return view('admin.businessManager.manager',compact('activeBusinessManagers'));
        }
        
        public function businessmanagerInactif(){
            $inactiveBusinessManagers = User::where('role', 'businessManager')->where('actif', 0)->get();
    
            return view('admin.businessManager.managerInactive',compact('inactiveBusinessManagers'));
        }
    
        public function create()
        {
            return view('admin.businessManager.create');
        }
        ...
        // Création de l'utilisateur (businessManager) dans la table users
        $user = new User;
        ...
        return redirect()->route('admin.businessManager.manager')->with('success', 'Business Manager créé avec succès.');
        }
        ...
        public function toggle($id)
        {
            ...
            return redirect()->back()->with('success', 'Chargé Entreprise activée/désactivée avec succès.');
        }
        public function edit($id)
        {
            $user = User::findOrFail($id);
            if (!$user) {
            return redirect()->route('admin.businessManager.manager')->with('error', 'business manager non trouvée');
            }

            return view('admin.businessManager.edit_manager', compact('user'));
        }
        ...
        public function update(Request $request, $id)
        {
            ...
            $customMessages = [
                ...
                'phone.required' => 'Le champ Téléphone est requis.',
                'phone.regex' => 'Le Téléphone doit contenir uniquement des chiffres.',
                'phone.between' => 'Le Téléphone doit contenir entre 10 et 20 chiffres.',
            ...
            return redirect()->route('admin.businessManager.manager')->with('success', 'Manager mis à jour avec succès.');
        }
}
