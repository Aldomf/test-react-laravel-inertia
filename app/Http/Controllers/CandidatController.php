...
class CandidatController extends Controller
{
    ...
    {
        return Inertia::render('PreInscription');
    }
    ...
    public function register(Request $request)
    {
        ...
        return Inertia::visit(route('preinscription'))->with('success', "Votre préinscription a été enregistrée avec succès. Il ne vous reste désormais plus qu'à attendre que l'un de nos conseillers prenne contact avec vous.");
    }
}
